...
<div class="page-content">
    <form method="POST" action="{{ route('admin.posts.update', $post->id) }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" id="inputName" class="form-control @error('title') is-invalid @enderror" value="{{$post->title}}">
            @error('title')
        ...
        <div class="form-group">
            ...
            <div id="quill-editor" class="mb-3" style="height: 300px;">{!! $post->body !!}</div>
            <textarea rows="3" class="mb-3 d-none" name="body" id="quill-editor-area">{{$post->body}}</textarea>
            @error('body')
                <div><small class="text-danger">{{ $message }}</small></div>
            @endif
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-3">
                <label for="location" class="form-label">News Location</label>
                <div class="control-col">
        ...
        <div class="form-group row">
            <div class="col-md-2">
                <input type="checkbox" name="active" id="active" @if($post->active) checked @endif><label for="active">Published</label>
            </div>
        </div>
        <div class="form-group">
